     ...
     return (
          ...
          <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
               ...
               <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                         <h3 className="tracking-wide text-xl font-bold uppercase dark:text-gray-50">Company</h3>
                         <ul className="space-y-1">
                              <li>
                    ...
                    <div className="space-y-3">
                         <div className="uppercase text-xl font-bold dark:text-gray-50">Social media</div>
          ...
          <div className="py-6 text-sm text-center dark:text-gray-400">© {moment().format(" YYYY")} Company Co. All rights reserved.</div>
     </footer>
     );
};
