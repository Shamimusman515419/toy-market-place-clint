                    ...
                    <div className="drawer-side">
                         ...
                         <ul className="menu p-4 w-80 h-full bg-[#d59578b8] ">
                              <div className=" text-center  flex  flex-col justify-center items-center mx-auto ">
                                   ...
                                   <h1 className=" text-black  text-xl font-bold"> {user?.displayName} </h1>
                              </div>
                              ...
                              {Admin == true ? <>
                                   ...
                                   <NavLink className={({ isActive }) =>
                                        isActive ? " text-white flex gap-3 items-center bg-blue-600  my-3 text-xl font-medium py-1   rounded-md px-5" : " text-xl gap-3  text-black   rounded-md flex items-center  font-medium py-1 px-5"
